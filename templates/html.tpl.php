...
<!--[if lte IE 8]> <html class="ie8-and-below" <?php print $html_attributes; ?> <?php print $rdf_namespaces; ?>> <![endif]-->
<!--[if IE 9]> <html class="ie9" <?php print $html_attributes; ?> <?php print $rdf_namespaces; ?>> <![endif]-->
<!--[if !IE]><!--> <html class="not-ie-and-ie10-and-above" <?php print $html_attributes; ?> <?php print $rdf_namespaces; ?>> <!--<![endif]--> <?php // Not IE & IE not using conditional comments (IE10+) ?>
